...
import VirtualMemory from "../../components/pcb/VirtualMemory";
  ...
  return (
    <>
      <div className="h-screen">
        ...
        <Tabs defaultValue="Tabs" className="grid relative flex bg-orange-50  w-full ">
          <TabsList>
            <TabsTrigger value="Scheduler">Scheduler</TabsTrigger>
            <TabsTrigger value="Virtual Memory">Virtual Memory</TabsTrigger>
          </TabsList>
          <TabsContent value="Scheduler"></TabsContent>
          <TabsContent value="Virtual Memory"><VirtualMemory /></TabsContent>
        </Tabs>
        <div defaultValue="Scheduler" className="grid grid-cols-3 grid-rows-4 relative flex bg-orange-50 h-[790px] w-full p-5 justify-center items-center gap-4 box-shadow-lg">
            ...
            <Card className="bg-slate-100 h-full">
              ...
              <CardContent className="justify-center items-center h-[100px] py-2 grid grid-cols-4">
                <div>
                  <p>Current Job</p>
                  <p>
                    <b className="text-2xl">{simulation?.jobText}</b>
                  </p>
                </div>
                <div>
                  <p>Current Time</p>
                  <p>
                    <b className="text-2xl">{simulation?.time}</b>
                  </p>
                </div>
                <div>
                  <p>Idle Time</p>
                  <p>
                    <b className="text-2xl">{simulation?.idleTime}</b>
                  </p>
                </div>
                <div>
                  <p>Utilization</p>
                  <p>
                    <b className="text-2xl">{simulation?.utilization}%</b>
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-100 h-full">
              ...
              <CardContent className="justify-center items-center h-[100px] py-2 grid grid-cols-2">
                <div>
                  <p>Waiting</p>
                  <p>
                    <b className="text-2xl">{simulation?.averageWait}</b>
                  </p>
                </div>
                <div>
                  <p>Turnaround Time</p>
                  <p>
                    <b className="text-2xl">{simulation?.averageTurnaround}</b>
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="items-center justify-center h-[100px] py-2 grid grid-cols-6">
                ...
                <div className="grid col-span-5 justify-items-start">
                  ...
                  {simulation?.readyQueue.map((item, index) => (
                    <div key={index} className={`gantt-lg-${item.id}`}>
                      {item.id}
                    </div>
                  ))}
                </div>
              ...
              <CardContent className="items-center justify-center h-[100px] py-2 grid grid-cols-10">
                ...
                <div className="grid col-span-9 justify-items-start">
                  ...
                  {simulation?.ganttChart.map((item, index) => (
                    <div key={index} className={`gantt-sm-${item}`}>
                      {item}
                    </div>
                  ))}
                </div>
